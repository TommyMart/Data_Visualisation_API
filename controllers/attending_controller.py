...
# Function to fetch all attendees for a specific event
...
@jwt_required() # Protect the route with JWT
# Function to fetch a specific attendee for an event
...
@jwt_required() # Protect the route with the jwt_required()
