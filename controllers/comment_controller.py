...
# No need to create a fetch all comments route because it would have
# no purpose, we only want all the comments linked to one post, which
# we get when fetching posts.
