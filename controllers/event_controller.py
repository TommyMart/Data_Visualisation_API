...
def get_single_event(event_id):
    # Select a single iteration of the Event Model from the DB, filter the data to find an entry where the event_id sent in the payload matches an id in the DB
