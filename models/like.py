...
class Like(db.Model):
    ...
    # Comment ID column - Foreign key referencing the ID attribute from the comments table (comment_id is commented out)
    ...
    # Link to the Comment model (comment_id is commented out, but can be used if needed)
