...
class EventSchema(ma.Schema):
    try:
        ...
        Length(max=400, error="Event description must be less than 400 characters long"),
        ...
        ticket_price = fields.Float(validate=And(
            # Ticket price must be greater than or equal to 0.00
            Regexp(r"^[0-9]\d*(\.\d+)?$", 
